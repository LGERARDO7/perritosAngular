'use strict';
//Modulo que inicia una configuración.//
module.exports = function(grunt)
{
	//Libreria que nos indica cuanto tiempo se tardo en la configuración.//
	...
	grunt.initConfig({
		...
		watch: {//Hilo que detecta cada vez que hay una modificación.//
			someFiles: {
